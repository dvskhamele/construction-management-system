...
test.describe('BuildMate Construction Management System - Smart Features', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('http://localhost:3001');
  });

  test('should display BuildMate homepage with construction management focus', async ({ page }) => {
