      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <div className="flex flex-col">
            <div>
              ...
              <p className="text-slate-600 text-sm">Here's what's happening with your construction projects today.</p>
            </div>
            <div className="mt-3">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          <div 
            ...
            onClick={() => startEditing('occupancyRate', stats.projectCompletionRate)}
          >
            <div className="flex justify-between items-start">
              <div>
                <p className="text-xs font-medium text-slate-500">Project Completion</p>
                {editingStat === 'projectCompletionRate' ? (
                  <div className="mt-1">
                    <input
                      type="number"
                      value={editValue}
                  ...
                  <p className="text-2xl font-bold text-slate-800 mt-1">{stats.projectCompletionRate}%</p>
                )}
              </div>
          ...
          <div 
            ...
            onClick={() => startEditing('staffActive', stats.teamActive)}
          >
            <div className="flex justify-between items-start">
              <div>
                <p className="text-xs font-medium text-slate-500">Active Team</p>
                {editingStat === 'teamActive' ? (
                  <div className="mt-1">
                    <input
                      type="number"
                      value={editValue}
                  ...
                  <p className="text-2xl font-bold text-slate-800 mt-1">{stats.teamActive}</p>
                )}
              </div>
            ...
            <table className="min-w-full divide-y divide-slate-200">
              <thead className="bg-slate-50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Project</th>
              ...
              <tbody className="bg-white divide-y divide-slate-200">
                {requests.slice(0, 3).map((request: any) => (
                  <tr 
                    ...
                    onClick={() => router.push(`/tasks/${request.id}`)}
                  >
