      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-6 rounded-2xl border-l-4 border-rose-500">
              <h3 className="text-xl font-bold text-slate-800 mb-3">Workers Don't Update Progress</h3>
              <p className="text-slate-600">Daily confusion + client complaints</p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border-l-4 border-amber-500">
              ...
              <p className="text-slate-600">Delays, cash stuck, rework</p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border-l-4 border-emerald-500">
              ...
              <p className="text-slate-600">You lose credibility</p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border-l-4 border-blue-500">
              ...
              <p className="text-slate-600">Small mistakes → big cost</p>
            </div>
            
            <div className="bg-slate-50 p-6 rounded-2xl border-l-4 border-purple-500 lg:col-span-2">
              <h3 className="text-xl font-bold text-slate-800 mb-3">Data Scattered Across Platforms</h3>
              <p className="text-slate-600">No clarity, no control — WhatsApp, Excel, PDFs everywhere</p>
            </div>
          </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-teal-500 to-teal-600 rounded-2xl p-8 text-white">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-2/3 mb-6 md:mb-0">
                ...
                <p className="mt-4 font-bold">— Ramesh, Contractor, Delhi</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8 bg-white p-6 rounded-2xl shadow-md">
                ...
                <p className="mt-4 font-bold text-slate-800">— Amit Patel, Builder, Gurgaon</p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-teal-600">1200+</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl">
              ...
              <p className="mt-4 font-bold text-slate-800">— Suresh Kumar, Contractor, Delhi</p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl">
              ...
              <p className="mt-4 font-bold text-slate-800">— Neha Gupta, PM, Delhi</p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl">
              ...
              <p className="mt-4 font-bold text-slate-800">— Manoj Singh, Builder, Gurgaon</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              All plans come with self-managing logic built-in — zero manual setup.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="border border-slate-200 rounded-2xl p-8">
              ...
              <div className="text-4xl font-bold text-slate-800 mb-6">₹20,000<span className="text-lg font-normal text-slate-600">/year</span></div>
              ...
              <p className="text-sm text-slate-500 mb-6">Used by 40 small contractors in Delhi</p>
              <Link 
                href="/signup" 
            ...
            <div className="border-2 border-teal-500 rounded-2xl p-8 relative">
              ...
              <div className="text-4xl font-bold text-slate-800 mb-6">₹45,000<span className="text-lg font-normal text-slate-600">/year</span></div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-teal-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <p className="text-sm text-slate-500 mb-6">Used by 35 mid-level builders, avg. 30% faster completion</p>
              <Link 
                href="/signup" 
            ...
            <div className="border border-slate-200 rounded-2xl p-8">
              ...
              <div className="text-4xl font-bold text-slate-800 mb-6">₹85,000<span className="text-lg font-normal text-slate-600">/year</span></div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-teal-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <p className="text-sm text-slate-500 mb-6">Used by 25 large developers, 3x team coordination improvement</p>
              <Link 
                href="/signup" 
                className="block w-full bg-slate-800 text-white text-center py-3 px-4 rounded-lg font-medium hover:bg-slate-700 transition"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-md text-center">
              ...
              <p className="text-slate-600">New projects start with prosperity energy</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md text-center">
              ...
              <p className="text-slate-600">Growth & knowledge direction</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md text-center">
              ...
              <p className="text-slate-600">Completion energy alignment</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md text-center">
              ...
              <p className="text-slate-600">Natural energy balance in UI</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">
                True construction process automation for builders who want to focus on building, not managing software.
              </p>
            </div>
