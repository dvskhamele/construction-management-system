...
export default function CreateSite() {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      setUser({ name: 'Site Manager', role: 'ADMIN' });
      setIsLoggedIn(true);
    } else {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      alert(`Site "${formData.name}" created successfully!`)
      router.push('/sites')
    }
  }
      ...
      <UserLayout user={user} onLogout={handleLogout}>
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Create New Site</h1>
              <p className="text-slate-600">Add a new construction site to your dashboard</p>
            </div>
