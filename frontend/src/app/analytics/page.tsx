...
export default function Analytics() {
  ...
  const fetchAnalyticsData = async () => {
    try {
      ...
      // Mock data for construction analytics
      const mockResponseTimeStats = {
        averageResponseTime: 28,
        responseTimeTrend: [
          { date: '2023-05-01', responseTime: 32 },
          { date: '2023-05-02', responseTime: 28 },
          { date: '2023-05-03', responseTime: 30 },
          { date: '2023-05-04', responseTime: 24 },
          { date: '2023-05-05', responseTime: 31 },
          { date: '2023-05-06', responseTime: 27 },
          { date: '2023-05-07', responseTime: 29 }
        ],
        departmentResponseTimes: [
          { department: 'Foundation', averageTime: 25 },
          { department: 'Framing', averageTime: 32 },
          { department: 'Electrical', averageTime: 28 },
          { department: 'Plumbing', averageTime: 30 }
        ]
      }
      ...
      const mockProductivityStats = {
        ...
        departmentProductivity: [
          { department: 'Foundation', productivity: 90 },
          { department: 'Framing', productivity: 83 },
          { department: 'Electrical', productivity: 87 },
          { department: 'Finishing', productivity: 89 }
        ],
        topPerformers: [
          { name: 'Raj Sharma', department: 'Foundation', productivity: 94 },
          { name: 'Amit Patel', department: 'Framing', productivity: 92 },
          { name: 'Suresh Kumar', department: 'Electrical', productivity: 90 }
        ],
        productivityTrend: [
          { date: '2023-05-01', productivity: 82 },
          { date: '2023-05-02', productivity: 83 },
          { date: '2023-05-03', productivity: 86 },
          { date: '2023-05-04', productivity: 85 },
          { date: '2023-05-05', productivity: 87 },
          { date: '2023-05-06', productivity: 86 },
          { date: '2023-05-07', productivity: 88 }
        ]
      }
      ...
      const mockRequestTrends = {
        totalRequests: 145,
        requestTypes: [
          { type: 'Foundation', count: 38, percentage: 26 },
          { type: 'Framing', count: 25, percentage: 17 },
          { type: 'Electrical', count: 32, percentage: 22 },
          { type: 'Finishing', count: 30, percentage: 21 },
          { type: 'Plumbing', count: 20, percentage: 14 }
        ],
        peakRequestTimes: [
          { hour: '08:00', count: 8 },
          { hour: '09:00', count: 12 },
        ...
        requestStatusDistribution: [
          ...
          { status: 'IN_PROGRESS', count: 22, percentage: 15 },
          { status: 'COMPLETED', count: 108, percentage: 75 }
        ]
      }
  ...
  const exportReport = () => {
    ...
    alert('Construction project report exported successfully!')
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-slate-800">Construction Analytics & Reporting</h2>
            <p className="text-slate-600">Insights into construction project performance</p>
          </div>
          <button 
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow p-6">
                <h3 className="text-lg font-semibold text-slate-800 mb-4">Task Response Time Trend</h3>
        ...
        {activeTab === 'trends' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow p-6">
                <h3 className="text-lg font-semibold text-slate-800 mb-4">Task Types Distribution</h3>
                <div className="space-y-4">
                  {requestTrends.requestTypes?.map((type: any, index: number) => (
                    <div key={index} className="border border-slate-200 rounded-lg p-4">
                      ...
                      <div className="text-sm text-slate-500 mt-1">{type.count} tasks</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow p-6">
                <h3 className="text-lg font-semibold text-slate-800 mb-4">Peak Task Times</h3>
                <div className="h-64 flex items-end space-x-2">
                ...
                <div className="w-64 h-64 relative">
                  {requestTrends.requestStatusDistribution && (
                    <>
                      ...
                      {/* IN_PROGRESS - 15% (54 degrees) */}
                      <div className="absolute inset-0 rounded-full border-8 border-blue-500" style={{ clipPath: 'polygon(50% 50%, 61.8% 11.8%, 80.9% 39.1%)' }}></div>
                      
                      {/* COMPLETED - 75% (270 degrees) */}
                      <div className="absolute inset-0 rounded-full border-8 border-emerald-500" style={{ clipPath: 'polygon(50% 50%, 80.9% 39.1%, 50% 100%)' }}></div>
                    </>
                  )}
