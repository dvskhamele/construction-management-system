...
export default function EquipmentUtilizationTracker() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('/api/tools/equipment-utilization-tracker', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <Head>
        <title>Equipment Utilization Tracker - BuildMate</title>
        <meta name="description" content="Helps track and optimize the usage of construction equipment across multiple projects, identifying underutilized assets and maintenance needs." />
        <meta property="og:title" content="Equipment Utilization Tracker - BuildMate" />
        <meta property="og:description" content="Helps track and optimize the usage of construction equipment across multiple projects, identifying underutilized assets and maintenance needs." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourdomain.com/tools/equipment-utilization-tracker" />
      </Head>
      ...
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-center text-gray-600 mb-8">
          Helps track and optimize the usage of construction equipment across multiple projects, identifying underutilized assets and maintenance needs.
        </p>
