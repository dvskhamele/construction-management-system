...
export default function CrewSchedulingOptimizer() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('/api/tools/crew-scheduling-optimizer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <Head>
        <title>Crew Scheduling Optimizer - BuildMate</title>
        <meta name="description" content="Optimizes crew assignments based on individual availability, skill sets, project phase, and task dependencies to maximize efficiency and minimize downtime." />
        <meta property="og:title" content="Crew Scheduling Optimizer - BuildMate" />
        <meta property="og:description" content="Optimizes crew assignments based on individual availability, skill sets, project phase, and task dependencies to maximize efficiency and minimize downtime." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourdomain.com/tools/crew-scheduling-optimizer" />
      </Head>
      ...
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-center text-gray-600 mb-8">
          Optimizes crew assignments based on individual availability, skill sets, project phase, and task dependencies to maximize efficiency and minimize downtime.
        </p>
