  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      <aside 
        ...
        } lg:translate-x-0 lg:static lg:w-64 lg:flex lg:flex-col`}
      >
      ...
      {/* Main Content */}
      <div className={`${isSidebarOpen ? 'lg:ml-0' : 'ml-0'} transition-all duration-300`}>
        <div className="flex">
          {/* Sidebar - hidden on mobile unless open */}
          <div className={`${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:w-64 fixed lg:static z-40 h-[calc(100vh-4rem)] lg:h-screen w-64 transition-all duration-300 ease-in-out overflow-hidden`}>
            <Sidebar 
              user={user} 
              onLogout={onLogout} 
