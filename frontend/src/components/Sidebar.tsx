...
const Sidebar: React.FC<SidebarProps> = ({ user, onLogout, isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out h-screen overflow-y-auto ${
          isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0 md:static md:w-64`}
      >
        <div className="flex flex-col h-full border-r border-slate-200 overflow-y-auto">
          {/* Sidebar Header */}
