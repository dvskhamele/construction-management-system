...
# BuildMate Construction Management App Deployment Script
# This script deploys the Construction Management application to Vercel

echo "🏗️ BuildMate Construction Management App Deployment Script"
echo "=========================================================="

# Check if we're in the right directory
BASE_DIR="/Users/test/startups/constructionmanagement"
if [ ! -d "$BASE_DIR" ]; then
    echo "❌ Error: Construction Management directory not found at $BASE_DIR"
    exit 1
fi
...
echo "  • Frontend: Next.js construction management application"
